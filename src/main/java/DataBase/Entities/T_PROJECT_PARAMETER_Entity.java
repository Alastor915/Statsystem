...
public class T_PROJECT_PARAMETER_Entity implements Serializable{
    ...
    private java.util.Set<T_PROJECT_has_T_PROJECT_PARAMETER_Entity> projpar = new HashSet<T_PROJECT_has_T_PROJECT_PARAMETER_Entity>(0);
    public java.util.Set<T_PROJECT_has_T_PROJECT_PARAMETER_Entity> getProjPar(){
        return projpar;
    }
