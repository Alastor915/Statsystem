...
public class T_PROJECT_Entity implements Serializable {
    ...
    @OneToMany
    @JoinTable(name = "PROJECT_ID")
    private Set<T_PROJECT_has_T_PROJECT_PARAMETER_Entity> projpar = new HashSet<T_PROJECT_has_T_PROJECT_PARAMETER_Entity>(0);
    public Set<T_PROJECT_has_T_PROJECT_PARAMETER_Entity> getProjPar(){
        return projpar;
    }
